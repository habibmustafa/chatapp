...
export const ChatContainer = ({ socket }) => {
   ...
   return (
      <div
         className={`chatcontainer flex-1 bg-white mr-0.5 transition-all duration-300 h-full relative tablet:absolute tablet:z-20 tablet:w-full ${
      ...
      >
         {chatUser ? (
            <div className="flex h-full flex-col">
               ...
               <ChatInput sendMessage={sendMessage} time={time} />
            </div>
         ) : (
            <Welcome />
         )}
