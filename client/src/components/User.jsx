...
export const User = ({ ...user }) => {
   ...
   return (
      <div
         ...
         className="cursor-pointer rounded-1 text-[15px] text-[#7a7f9a] leading-[22.5px] py-4 px-5 flex justify-between gap-4 transition-all duration-200 hover:bg-[#e6ebf5]"
      >
